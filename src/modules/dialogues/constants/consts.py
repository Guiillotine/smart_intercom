...
- visitor_goal: краткая формулировка цели визита; если цель ещё не ясна, верни null; Если ты установил goal_identified в true, то это поле обязательно должно быть заполнено.

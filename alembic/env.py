...
from src.client.storages.postgres.utils.metadata import target_metadata  # noqa
...
def run_migrations_offline():
    ...
    if not url:
        url = _settings.postgres.sync_url
...
def run_migrations_online():
    ...
    if not config.get_main_option("sqlalchemy.url", None):
        configuration["sqlalchemy.url"] = _settings.postgres.sync_url
    ...
    with connectable.connect() as connection:
        ...
        for data in SchemaNamesEnum:
            schema: SchemaNamesEnum = data
